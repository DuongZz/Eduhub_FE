  ...
  return (
    <div className="w-full sm:w-2/3 md:w-1/2 lg:w-1/3">
      <div className="flex flex-col w-full bg-white">
        {/* Tiêu đề */}
        <h1 className="text-lg text-[#003555] font-bold uppercase p-[30px]">
          Đăng nhập
        </h1>
        ...
        <form onSubmit={handleSubmit} className="text-sm px-[30px] pb-[30px] ">
          ...
          <div className=" text-slate-400 text-xs">
            ...
            <div className="flex justify-between text-black gap-3">
              <div
                className="flex items-center gap-1 justify-center border w-full border-solid border-slate-400 py-2 rounded-[2px] cursor-pointer"
        ...
        <div className="mb-[30px] flex justify-center text-sm">
          <span className="text-slate-400">
            Bạn mới biết đến Eduhub?{" "}
            <Link
              className="text-[#003555] hover:underline font-medium"
              href={"/register"}
            >
              Đăng ký
            </Link>
