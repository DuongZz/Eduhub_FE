      ...
      <div className="max-w-8xl mx-auto px-4 xl:px-20 md:px-10 lg:py-14 py-8">
        <div className="flex flex-col gap-5">
          <h3 className="font-medium text-2xl text-center">
            DANH SÁCH GIẢNG VIÊN TRÊN EDUHUB
          </h3>
          <form
            action=""
            className="grid lg:grid-cols-12 grid-cols-4 gap-4 text-sm"
          >
            <select
              className="custom-select-arrow border border-solid border-black relative col-span-2 bg-transparent px-4 py-[10px] rounded outline-none"
              name=""
              id=""
            >
